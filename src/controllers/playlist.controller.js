...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    if (!playlist) throw new ApiError(404, "Playlist not found");
    if (playlist.owner.toString() !== req.user._id.toString()) throw new ApiError(403, "Not authorized to modify this playlist");
...
const deletePlaylist = asyncHandler(async (req, res) => {
    ...
    const playlist = await Playlist.findById(playlistId);
    if (!playlist) throw new ApiError(404, "Playlist not found");
    if (playlist.owner.toString() !== req.user._id.toString()) throw new ApiError(403, "Not authorized to delete this playlist");
